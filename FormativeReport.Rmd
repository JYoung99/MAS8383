...
An important practice in PCA is the standardising of data - this means that
...
higher readings of pollution will have larger component scores - and all scores
will be positive for this component as there are no negative coefficients.
...
a high PC score for PC2, and vice versa.

### How many Principal Components?

Now we have our principal components, we can decide how many to use 

```{r variance proportion}
prop_var <- pca_airpol$sdev^2 / sum(pca_airpol$sdev^2)
head(prop_var)
